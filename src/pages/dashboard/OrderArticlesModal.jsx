...
function OrderArticlesModal({ isOpen, onClose, articles, onSaveOrder }) {
  const [orderedArticles, setOrderedArticles] = useState([]);

  useEffect(() => {
    if (isOpen) setOrderedArticles(articles);
  }, [isOpen, articles]);
  ...
  const handleDragEnd = (result) => {
    ...
    const reordered = Array.from(orderedArticles);
...
export default OrderArticlesModal;
